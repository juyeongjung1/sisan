...
export const INITIAL_HOLDINGS: AssetHolding[] = [
  ...
  },
  {
    ...
    officialReturnPercent: 170.82,
    withdrawnAmountJpy: 800000,
    realizedGainJpy: 504000,
    fundCode: '9I31121B',
    units: 1205518,
    latestNavPrice: 15955,
    dailyChangeVal: -78,
    dailyChangePct: -0.49,
    notes: '旧NISA満了に伴い毎月取り崩し中。通算運用利回り+170.82%',
    updatedAt: new Date().toISOString(),
  },
  {
    id: 'hold_john_3',
