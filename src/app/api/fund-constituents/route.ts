...
const FUND_CONSTITUENTS_DATABASE: Record<string, FundConstituentsDetail> = {
  ...
  levnas: {
    ...
    constituents: [
      ...
      { rank: 5, symbol: 'AVGO', name: 'Broadcom', nameKo: '브로드컴', weightPct: 4.8, sector: '半導体', sectorKo: '반도체', description: 'カスタムAI半導体', descriptionKo: '커스텀 AI ASIC, 통신 칩' },
  ...
  sp500: {
    ...
    constituents: [
      ...
      { rank: 9, symbol: 'AVGO', name: 'Broadcom', nameKo: '브로드컴', weightPct: 1.6, sector: 'IT', sectorKo: 'IT', description: '半導体・ソフト', descriptionKo: '반도체·소프트웨어' },
